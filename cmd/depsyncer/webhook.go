...
type DeviceResponseEvent struct {
	...
	DeviceResponse *godep.FetchDeviceResponse `json:"device_response,omitempty"`
}
...
func (w *Webhook) CallWebhook(ctx context.Context, name string, isFetch bool, resp *godep.FetchDeviceResponse) error {
