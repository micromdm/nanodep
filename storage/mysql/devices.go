...
func (s *MySQLStorage) StoreDevices(ctx context.Context, depName string, devices []godep.Device) error {
	if len(devices) < 1 {
		return nil
	}
...
func (s *MySQLStorage) QueryDevices(ctx context.Context, req *storage.DevicesQueryRequest) (*storage.DevicesQueryResult, error) {
...
func (s *MySQLStorage) DeleteDevices(ctx context.Context, depName string, serials []string) error {
	if len(serials) < 1 {
		return nil
	}
